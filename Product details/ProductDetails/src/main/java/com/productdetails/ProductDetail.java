...
import com.productdetails.DBConnection;
...
public class ProductDetail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            DBConnection conn = new DBConnection("jdbc:mysql://localhost:3306/ecommerce1", "root", "ame170102");
            ...
            ResultSet rst = stmt.executeQuery("select * from petsproduct");
            ...
            else 
            {
            	...
            	String sql_res= "select * from petsproduct where id=" + productSearch;
